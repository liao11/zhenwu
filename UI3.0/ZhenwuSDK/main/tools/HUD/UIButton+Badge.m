...
- (void)badgeInit
{
    ...
    self.badgeFont      = [UIFont systemFontOfSize:7.0];
    self.badgePadding   = 6;
    self.badgeMinSize   = 6;
//    self.badgeOriginX   = self.frame.size.width - self.badge.frame.size.width/2 - 19;
    self.badgeOriginX   = self.frame.size.width/2 +8;
    self.badgeOriginY   = 5;
...
-(void) setBadgeValue:(NSString *)badgeValue
{
    ...
    if([badgeValue isEqualToString:@"77"]){
        [self removeBadge];
    }
