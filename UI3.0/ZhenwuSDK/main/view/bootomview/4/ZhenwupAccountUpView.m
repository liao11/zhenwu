...
@interface ZhenwupAccountUpView () <KeenWireFieldDelegate, EM_VerifyInputTextFieldDelegate,EmpriSegViewDelegate>
...
@end
@implementation ZhenwupAccountUpView
...
-(void)setupContent{
    ...
    self.title=@"Thăng cấp tài khoản";
    
    
    
    UIView * inputBgView = [[UIView alloc] initWithFrame:CGRectMake(55, 55+50, self.em_width - 110, 280)];
    [self addSubview:inputBgView];
    
    self.em14_segment = [[ZhenwupSegView alloc] initWithTitleArr:@[MUUQYLocalizedString(@"EMKey_Email_Text"), MUUQYLocalizedString(@"EMKey_WordTel")] WithFrame:CGRectMake(40, 0, inputBgView.em_width-80, 30)];
    ...
    self.em11_AccountUpgrade_inputAccView = [[KeenWireField alloc] initWithFrame:CGRectMake(0, self.em14_segment.em_bottom + 20, inputBgView.em_width, 50)];
    ...
    self.em11_AccountUpgrade_inputAccView.em14_fieldLeftIcon.frame= CGRectMake(13, 11.8+5, 22.3, 16.3);
    ...
    self.em11_AccountUpgrade_inputPwdView = [[KeenWireField alloc] initWithFrame:CGRectMake(0, self.em11_AccountUpgrade_inputAccView.em_bottom + 20, inputBgView.em_width, 50)];
...
//    self.em14_VerifyCode_InputView.em14_fieldLeftIcon.image = [ZhenwupHelper_Utils imageName:@"zhenwuimnewPwd"];
    self.em11_AccountUpgrade_inputPwdView.em14_fieldLeftIcon.frame= CGRectMake(13, 10.8+5, 18.6, 20.5);
    
    
    
    UIButton *eyeBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    eyeBtn.frame = CGRectMake(0, 0, 32, 32);
    eyeBtn.contentEdgeInsets = UIEdgeInsetsMake(7, 7+5, 7, 7);
    eyeBtn.selected = YES;
    self.em11_AccountUpgrade_inputPwdView.delegate = self;
    ...
    self.em11_AccountUpgrade_inputVerifyView = [[ZhenwupVerifyInPutTextField_View alloc] initWithFrame:CGRectMake(0, self.em11_AccountUpgrade_inputPwdView.em_bottom + 20, inputBgView.em_width, 50)];
    ...
    //    self.em14_VerifyCode_InputView.em14_fieldLeftIcon.image = [ZhenwupHelper_Utils imageName:@"zhenwuimnewPwd"];
        self.em11_AccountUpgrade_inputVerifyView.em14_fieldLeftIcon.frame= CGRectMake(13, 10.8+5, 18.6, 20.5);
    ...
    self.em14_confirmBtn.frame = CGRectMake(0, self.em18_protocolBtn.em_bottom + 5, 160, 34);
...
//            self.em11_AccountUpgrade_inputAccView.zwp01_tel = true;
            ...
            self.em11_AccountUpgrade_inputAccView.em14_fieldLeftIcon.frame= CGRectMake(13, 10+5, 13.1, 20);
